...
class ViewTopicDetailActivity : BaseActivity() {
    ...
    override fun setValues() {
        ...
        binding.firstSideTitleTxt.text = "${mTopicData.sideList[0]}표"
        binding.secondSideTitleTxt.text = "${mTopicData.sideList[1]}표"
        ...
        ServerUtil.getRequestTopicDetail(
            ...
            object : ServerUtil.JsonResponseHandler {
                override fun onResponse(jsonObj: JSONObject) {
                    ...
                    // 기존에 들어있던 댓글 목록을 전부 삭제하고 나서, add로 변경.
                    ...
                    for (i in 0 until repliesArr.length()) {
                        ...
                        val replyData = ReplyData.getReplyDataFromJson(jsonObj)
